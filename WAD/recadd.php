...
<?php
        ...
        if(isset($_POST['submit'])){
			...
			include "connect.php";
        $i = mysql_query("insert into receiptionist values('".$_POST['id']."','".trim($_POST['f_name'])."','".trim($_POST['l_name'])."','".trim($_POST['p_number1'])."','".trim($_POST['date'])."','".trim($_POST['age'])."',
        ...
        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=recadd.php">';
