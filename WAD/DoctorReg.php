...
<td><input type="NUMBER" name="p_number1" size="30" placeholder="Enter the contact number" maxlength="10"  pattern=".{9,}" required /></td></tr>
<tr>
...
$i = mysql_query("insert into doctor values('".$_POST['id']."','".trim($_POST['f_name'])."','".trim($_POST['l_name'])."','".trim($_POST['p_number1'])."','".trim($_POST['date'])."','".trim($_POST['age'])."','".trim($_POST['address'])."','".trim($_POST['gender1'])."','".trim($_POST['mail'])."','".trim($_POST['join'])."','".$aaa."','".trim($_POST['username'])."','".trim($_POST['password'])."')");
		//$x= mysql_query("insert into login values('".$_POST['id']."','".trim($_POST['username'])."','".trim($_POST['password'])."','".$des."')");
...
<script>
  ...
  if (el.value.length != 6) {
    alert("Password should be within 6 to 16 characters")
  }
</script>
