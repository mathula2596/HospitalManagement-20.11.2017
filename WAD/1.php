...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"><font style="font-size:18px;"><a href="Search_Window.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
    ...
    <?php
		...
		if($cbo=="ID"&&$text1=="")
		{
			$id = mysql_query("SELECT * FROM patient WHERE ID='$search'");
	?>
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:50px;"><?php echo $di[6]; ?></td>
                <td class="bod" style="text-align: center;"><?php echo $di[7]; ?></td>
                <td class="bod" style="text-align: center;  width:60px;"><?php echo $di[8]; ?></td>
				 <td class="bod" style="text-align: center;  width:90px;"><?php echo $di[9]; ?></td>
			</tr>
            <?php
		}
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:50px;"><?php echo $an[6]; ?></td>
                <td class="bod" style="text-align: center;"><?php echo $an[7]; ?></td>
                <td class="bod" style="text-align: center;  width:60px;"><?php echo $an[8]; ?></td>
				<td class="bod" style="text-align: center;  width:90px;"><?php echo $an[9]; ?></td>
			</tr>
            <?php
				}
			?>  
     <?php
		}else if($cbo=="Age"&&$text1=="")
				{
        $add = mysql_query("SELECT * FROM patient WHERE Age like '".$search."'");
     ?>
		<?php
		...
		?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:50px;"><?php echo $dda[6]; ?></td>
                <td class="bod" style="text-align: center;"><?php echo $dda[7]; ?></td>
                <td class="bod" style="text-align: center;  width:60px;"><?php echo $dda[8]; ?></td>
				<td class="bod" style="text-align: center;  width:90px;"><?php echo $dda[9]; ?></td>
			</tr>
     ...
     <?php
				...
				{
        $pn = mysql_query("SELECT * FROM patient WHERE C_N1 like '".$search."'");
     ?>
		<?php
		...
		?>
			<tr>
				<td class="bod" style="text-align: center; width:65px;"><?php echo $np[0]; ?></td>
				<td class="bod" style="text-align: center; "><?php echo $np[1]; ?></td>
                <td class="bod" style="text-align: center;   "><?php echo $np[2]; ?></td>
                <td class="bod" style="text-align: center; "><?php echo $np[3]; ?></td>
                <td class="bod" style="text-align: center; "><?php echo $np[4]; ?></td>
                <td class="bod" style="text-align: center;  width:90px;"><?php echo $np[5]; ?></td>
                <td class="bod" style="text-align: center;  width:50px;"><?php echo $np[6]; ?></td>
                <td class="bod" style="text-align: center;"><?php echo $np[7]; ?></td>
                <td class="bod" style="text-align: center;  width:60px;"><?php echo $np[8]; ?></td>
				<td class="bod" style="text-align: center;  width:90px;"><?php echo $np[9]; ?></td>
			</tr>
		...
		if($cbo1=="Date"&&$text=="")
		{
			$da = mysql_query("SELECT * FROM patient WHERE DOA like '".$date."'");
	?>
    <?php
	...
	?>
			...
			elseif($cbo1=="Date"&&$cbo=="ID")
		{
			$da = mysql_query("SELECT * FROM patient WHERE DOA like '".$date."' and ID='$search' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
			...
			elseif($cbo1=="Date"&&$cbo=="Name")
		{
			$da = mysql_query("SELECT * FROM patient WHERE DOA like '".$date."' and F_Name like '".$search."' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
		...
		<?php 
			...
			elseif($cbo1=="Date"&&$cbo=="Age")
		{
			$da = mysql_query("SELECT * FROM patient WHERE DOA like '".$date."' and Age like '".$search."' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
			...
			elseif($cbo1=="Date"&&$cbo=="Phone")
		{
			$da = mysql_query("SELECT * FROM patient WHERE DOA like '".$date."' and C_N1 like '".$search."' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
