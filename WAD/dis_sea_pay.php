...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="pay_sea.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
    	<tr>
               <th  width= 96 style="border-radius: 5px; text-align: center;  width:80px;  background-color:#51b8f1; color: #ffffff;" >Invoice ID</th>
            <th width= "119" style=" border-radius: 5px; text-align: center;  background-color:#51b8f1; color: #ffffff;">Cashier ID</th>
            <th width="117" style=" border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center; ">Patient ID</th>
            <th width="117" style=" border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center; ">Amount </th>
            
            <th width="109" style=" border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center;  width:90px;">Date</th>
    ...
    <?php
		...
		if($cbo=="Invoice ID")
		{
			$id = mysql_query("SELECT * FROM payment WHERE ID='$search'");
	?>
	...
	?>
		...
		}else if($cbo=="Patient ID")
		{
			$na = mysql_query("SELECT * FROM payment WHERE P_ID like '".$search."'");
	?>
    <?php
	...
	?>
			...
			?>  
     <?php
		}else if($cbo=="Cashier ID")
				{
        $add = mysql_query("SELECT * FROM payment WHERE C_ID like '".$search."'");
     ?>
		<?php
     ...
     <?php
				...
				{
        $pn = mysql_query("SELECT * FROM payment WHERE date like '".$search."'");
     ?>
		<?php
