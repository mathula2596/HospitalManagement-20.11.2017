...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="Update_here.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
    	<tr>
            ...
            <th width="117" style="border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center; ">Reason for Visit</th>
                        <th width="130" style="border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center;">Edit</th>
			...
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:60px;"><?php echo $di[8]; ?></td>
				 <td class="bod" style="text-align: center;  width:90px;"><?php echo $di[9]; ?></td>
				            <td class="bod" style="text-align: center; width:30px; " ><a href="update2.php? id=<?php echo $di[0];?>">Edit</a> </td>
	...
	?>
			<tr>
				...
				<td class="bod" style="text-align: center;  width:90px;"><?php echo $an[9]; ?></td>
				           <td class="bod" style="text-align: center; width:30px; " ><a href="update2.php? id=<?php echo $an[0];?>">Edit</a> </td>
	...
	?>
			<tr>
				...
				<td class="bod" style="text-align: center;  width:90px;"><?php echo $ad[9]; ?></td>
				           <td class="bod" style="text-align: center; width:30px; " ><a href="update2.php? id=<?php echo $ad[0];?>">Edit</a> </td>
