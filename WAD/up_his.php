...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="up_history.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
    	<tr>
           <th  width= "96px" style="border-radius: 5px; text-align: center;  width:80px;  background-color:#51b8f1; color: #ffffff;" >History No</th>
            ...
            <th width="550px" style=" border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center;  width:90px;">History </th>
                        <th width="130px" style="border-radius: 5px; background-color:#51b8f1; color: #ffffff; text-align: center;">Edit</th>
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center; width:30px; " ><a href="up_pa_history.php? H_id=<?php echo $di[0];?>">Edit</a> </td>
			</tr>
            <?php
		}
		}else if($cbo=="P_ID")
	...
	?>
			<tr>
              ...
              <td class="bod" style="text-align: center; width:30px; " ><a href="up_pa_history.php? H_id=<?php echo $an[0];?>">Edit</a> </td>
			</tr>
            <?php
				}
			?>  
     ...
     ?>
        ...
        <td class="bod" style="text-align: center; width:30px; " ><a href="up_pa_history.php? H_id=<?php echo $dda[0];?>">Edit</a> </td>
			</tr>
