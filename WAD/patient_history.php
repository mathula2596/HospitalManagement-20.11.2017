...
<td><input type="text" name="H_id" size="30" placeholder="Enter the No" readonly value="<?php echo $new ?>"   / ></td>
</tr>
<?php
 } 
 ?>
...
<td><textarea rows="10" cols="60" name="symptoms" required  > </textarea></td></tr>

<tr></tr><tr></tr>

<tr><td>
<label> History : </label></td>
<td><textarea rows="15" cols="60" name="history" required  > </textarea></td></tr>
...
<?php   
        ...
        include "connect.php";
        $i = mysql_query("insert into history values('".$_POST['H_id']."','".trim($_POST['id'])."','".trim($_POST['did'])."','".trim($_POST['symptoms'])."','".trim($_POST['history'])."')");
        if($i==true){
    ...
    echo '<script language="javascript">';
        ...
        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=patient_history.php">';
        }
        //if($i==true){
