...
<td><input type="text" name="id" size="30" placeholder="Enter the Receptionist ID" required / ></td>
</tr>
...
<?php   
        ...
        include "connect.php";
        $i = mysql_query("insert into rec_sch values('".$_POST['id']."','".trim($_POST['M_I'])."','".trim($_POST['M_O'])."','".trim($_POST['Tu_I'])."','".trim($_POST['Tu_O'])."','".trim($_POST['W_I'])."','".trim($_POST['W_O'])."','".trim($_POST['Th_I'])."','".trim($_POST['Th_O'])."','".trim($_POST['F_I'])."','".trim($_POST['F_O'])."','".trim($_POST['Sa_I'])."','".trim($_POST['Sa_O'])."','".trim($_POST['Su_I'])."','".trim($_POST['Su_O'])."')");
        if($i==true){
    ...
    echo '<script language="javascript">';
        ...
        echo '<META HTTP-EQUIV="Refresh" Content="0; URL=rec_add_sch.php">';
        }
        //if($i==true){
