...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"><a href="JavaScript:window.close()">Close </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<td><input type="text" name="f_name" size="30" placeholder="Enter the first name"  / ></td>
</tr>
...
<td><input type="NUMBER" name="p_number1" size="30" placeholder="Enter the contact number" required maxlength="10"  pattern=".{9,}" /></td></tr>
<tr>
...
<td><input type="password" name="password" size="30"  placeholder="Characters wwithin 4 to 16" required maxlength="16" pattern=".{4,}"   /></td></tr>

<tr></tr><tr></tr><tr></tr>

<tr><td>
<label> Confirm Password : </label></td>
<td><input type="password" name="c_password" size="30" placeholder="Retype the Password" maxlength="16" /></td></tr>
...
<?php
        ...
        if(isset($_POST['submit'])){
			...
			include "connect.php";
        $i = mysql_query("insert into admin values('".$_POST['id']."','".trim($_POST['f_name'])."','".trim($_POST['l_name'])."','".trim($_POST['p_number1'])."','".trim($_POST['date'])."','".trim($_POST['age'])."',
        '".trim($_POST['address'])."','".trim($_POST['gender1'])."','".trim($_POST['mail'])."','".trim($_POST['join'])."','".trim($_POST['username'])."','".trim($_POST['password'])."')");
