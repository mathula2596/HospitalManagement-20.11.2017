...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"><font style="font-size:18px;"><a href="upapp.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
			...
			if($di[3]!="")
{
	...
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $di[6]; ?></td>
                       <td class="bod" style="text-align: center; width:30px; " ><a href="appupdateform.php? A_ID=<?php echo $di[0];?>">Edit</a> </td>
			...
			if($an[3]!="")
{
	...
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $an[6]; ?></td>
                       <td class="bod" style="text-align: center; width:30px; " ><a href="appupdateform.php? A_ID=<?php echo $an[0];?>">Edit</a> </td>
			...
			if($dda[3]!="")
{
		...
		?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $dda[6]; ?></td>
                       <td class="bod" style="text-align: center; width:30px; " ><a href="appupdateform.php? A_ID=<?php echo $dda[0];?>">Edit</a> </td>
