...
<div class="summary"><label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="ward_delete_se.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:90px;"><?php echo $di[5]; ?></td>
                        <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_ward.php? A_id=<?php echo $di[0];?>">Delete</a> </td>
	...
	?>
       ...
       <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_ward.php? A_id=<?php echo $an[0];?>">Delete</a> </td>         
			</tr>
            <?php
				}
			?>  
     ...
     ?>
       ...
       <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_ward.php? A_id=<?php echo $dda[0];?>">Delete</a> </td>			</tr>
	...
	?>
       ...
       <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_ward.php? A_id=<?php echo $ad[0];?>">Delete</a> </td>     
