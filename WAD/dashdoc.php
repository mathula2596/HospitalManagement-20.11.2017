...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1298px;"><a href="out.php">Logout </font></a>
 </td></tr></table>
</div>
<!--logo file end-->
...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal; text-align:center; color:#51b8f1; font-size: 42px;" >Welcome To The Dashboard</h1><br><br>
 ...
 <nav class="navigation">
  <ul class="mainmenu" >
    ...
    <ul class="submenu">
        <li><a  href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a  href="View_Patientdoc.php"  onclick="window.open('View_Patientdoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
        ...
        <li><a  href="#" onClick="alert('Access Denied for this user...')">Update</a></li>
      </ul>
      </li>
    <li><a href="#">Appointments</a>
    <ul class="submenu">
        <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a href="view_appdoc.php"  onclick="window.open('view_appdoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
        ...
        <li><a href="#" onClick="alert('Access Denied for this user...')">Update</a></li>
        <li><a href="#" onClick="alert('Access Denied for this user...')">Cancel</a></li>
      </ul>
    </li>
    <li><a href="#">Payments</a>
      <ul class="submenu">
        <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a href="#" onClick="alert('Access Denied for this user...')">View</a></li>
                <li><a href="#" onClick="alert('Access Denied for this user...')">Search</a></li>
    ...
    <ul class="submenu">
        <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a href="view_warddoc.php"  onclick="window.open('view_warddoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
        ...
        <li><a href="#" onClick="alert('Access Denied for this user...')">Update</a></li>
        <li><a  href="#" onClick="alert('Access Denied for this user...')">Delete</a></li>
 ...
 <li><a href="opp_se.php" onclick="window.open('opp_se.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Search</a></li>
    ...
    <ul class="submenu">
         <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a  href="view_doctorrec.php"  onclick="window.open('view_doctorrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
        ...
        <li><a href="#" onClick="alert('Access Denied for this user...')">Delete</a></li>
        <li><a href="#" onClick="alert('Access Denied for this user...')">Schedule</a></li>
    ...
    <ul class="submenu">
         <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li><a  href="view_recrec.php"  onclick="window.open('view_recrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
    ...
    <ul class="submenu">
         <li><a href="#" onClick="alert('Access Denied for this user...')">Add</a></li>
        <li>    <a href="view_adminrec.php"  onclick="window.open('view_adminrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
</li>
...
<button onclick="myFunction()" class="dropbtn">Patients</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="#" onClick="alert('Access Denied for this user...')"> Add</a>
    <a href="View_Patientdoc.php"  onclick="window.open('View_Patientdoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
    ...
    <a href="#" onClick="alert('Access Denied for this user...')">Update</a>
...
<button onclick="myFunction1()" class="dropbtn1">Appointments</button>
  <div  id="myDropdown1" class="dropdown-content1" >
    <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
        <a href="view_appdoc.php"  onclick="window.open('view_appdoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
        ...
        <a  href="#" onClick="alert('Access Denied for this user...')">Update</a>
        <a href="#" onClick="alert('Access Denied for this user...')">Cancel</a>
  </div>
</div>
...
<button onclick="myFunction2()" class="dropbtn2">Payments</button>
  <div id="myDropdown2" class="dropdown-content2">
    <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    <a href="#" onClick="alert('Access Denied for this user...')">View</a>
    
           <a href="#" onClick="alert('Access Denied for this user...')">Search</a>
...
<button onclick="myFunction3()" class="dropbtn3">Wards</button>
  <div id="myDropdown3" class="dropdown-content3">
    <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    <a href="view_warddoc.php"  onclick="window.open('view_warddoc.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
     <a href="ward_se.php"  onclick="window.open('ward_se.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Search</a>
    <a href="#" onClick="alert('Access Denied for this user...')">Update</a>
     <a href="#" onClick="alert('Access Denied for this user...')">Delete</a>
...
<button onclick="myFunction4()" class="dropbtn4">Operation Theater</button>
  <div id="myDropdown4" class="dropdown-content4">
    ...
    <a hhref="opp_up.php" onclick="window.open('opp_up.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Update</a>
...
<button onclick="myFunction6()" class="dropbtn6">Doctors</button>
  <div id="myDropdown6" class="dropdown-content6">
    <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    <a href="view_doctorrec.php"  onclick="window.open('view_doctorrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
    <a href="doc_se.php"  onclick="window.open('doc_se.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Search</a>
     <a href="doc_up_se.php"  onclick="window.open('doc_up_se.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Update</a>
      <a href="#" onClick="alert('Access Denied for this user...')">Delete</a>
       <a href="#" onClick="alert('Access Denied for this user...')">Schedule</a>
...
<button onclick="myFunction7()" class="dropbtn7">Receptionist</button>
  <div id="myDropdown7" class="dropdown-content7">
     ...
     <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    <a  href="view_recrec.php"  onclick="window.open('view_recrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
...
<button onclick="myFunction8()" class="dropbtn8">Admin</button>
  <div id="myDropdown8" class="dropdown-content8">
    ...
    <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    <a href="view_adminrec.php"  onclick="window.open('view_adminrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
