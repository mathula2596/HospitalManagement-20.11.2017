...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
<br><br><h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal; text-align:center; color:#51b8f1;"> Admin Details</h1><br>
...
<form action="" name="myform" method="post" enctype="multipart/form-data">
  ...
  <?php
  			include "connect.php";
  			$i = "select * from admin where ID='$_GET[id]'";
  			$h = mysql_query($i);
...
<?php
    ...
    //  $i = mysql_query("UPDATE  appointment SET  P_ID='".$_POST['pid']."',Reason='".$_POST['reason']."',Doctor_Type='".$_POST['type1']."',Doctor_ID='".$_POST['doctor']."',	Date='".$_POST['date']."',Time='".$_POST['time']."'WHERE A_ID='".$_POST[A_ID]."'");
        ...
        $i = mysql_query("UPDATE admin SET F_Name='".$_POST['f_name']."',L_Name='".$_POST['l_name']."',Phone='".$_POST['p_number1']."',DOB='".$_POST['date']."',Age='".$_POST['age']."',Address='".$_POST['address']."',Gender='".$_POST['gender1']."',	Email='".$_POST['mail']."',DOJ='".$_POST['join']."',username='".$_POST['username']."',password='".$_POST['password']."'WHERE ID='".$_POST[id]."'");
