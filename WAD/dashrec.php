...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal; text-align:center; color:#51b8f1; font-size: 42px;" >Welcome To The Dashboard</h1><br><br>
 ...
 <li><a href="opp_se.php" onclick="window.open('opp_se.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">Search</a></li>
    ...
    <ul class="submenu">
        ...
        <li><a  href="view_p_historyrec.php"  onclick="window.open('view_p_historyrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a></li>
...
<button onclick="myFunction()" class="dropbtn">Patients</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="Patient_Registration.php"  onclick="window.open('Patient_Registration.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;"> Add</a>
...
<button onclick="myFunction5()" class="dropbtn5">Patient History</button>
  <div id="myDropdown5" class="dropdown-content5">
   <a href="#" onClick="alert('Access Denied for this user...')">Add</a>
    ...
    <a href="view_p_historyrec.php"  onclick="window.open('view_p_historyrec.php', 'newwindow',  ' width=1070, height=640','resizable=no' ); return false;">View</a>
