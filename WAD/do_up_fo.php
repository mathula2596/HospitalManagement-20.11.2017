...
<form action="" name="myform" method="post" enctype="multipart/form-data">
  ...
  <?php
          ...
          <td><input type="NUMBER" name="p_number1" size="30" value="<?php echo $tr[3]; ?>" maxlength="10"  pattern=".{9,}"  placeholder="Enter the contact number" /></td></tr>
          <tr>
          ...
          <label> Type : </label></td>
          <td><select name="type">
          <option selected hidden="">Choose the Type</option>
...
<option>Chemist</option>
          ...
          <td><input type="password" name="password" size="30" value="<?php echo $tr[12]; ?>"  placeholder="Enter the Password" required maxlength="16" pattern=".{4,}"  /></td></tr>

          <tr></tr><tr></tr><tr></tr>

          <tr><td>
          <label> Confirm Password : </label></td>
          <td><input type="password" name="c_password" size="30"   placeholder="Retype the Password" required maxlength="16"   /></td></tr>
...
if($_POST['type']=="General")
			...
			else if($_POST['type']=="Dentist")
			{
			$aaa="2";	
			}
			else if($_POST['type']=="Surgen")
			{
			$aaa="3";	
			}
			else if($_POST['type']=="Eye specialist")
			{
			$aaa="4";	
			}
			else if($_POST['type']=="Neurologist")
			{
			$aaa="5";	
			}
			else if($_POST['type']=="Physiatrist")
			{
			$aaa="6";	
			}
			else if($_POST['type']=="Chemist")
			{
			$aaa="7";	
			}
    ...
    //  $i = mysql_query("UPDATE  appointment SET  P_ID='".$_POST['pid']."',Reason='".$_POST['reason']."',Doctor_Type='".$_POST['type1']."',Doctor_ID='".$_POST['doctor']."',	Date='".$_POST['date']."',Time='".$_POST['time']."'WHERE A_ID='".$_POST[A_ID]."'");
        ...
        $i = mysql_query("UPDATE doctor SET first_name='".$_POST['f_name']."',last_name='".$_POST['l_name']."',phone='".$_POST['p_number1']."',dob='".$_POST['date']."',age='".$_POST['age']."',address='".$_POST['address']."',gender='".$_POST['gender1']."',email='".$_POST['mail']."',doj='".$_POST['join']."',type_id='".$aaa."',username='".$_POST['username']."',password='".$_POST['password']."'WHERE doctor_ID='".$_POST[D_id]."'");
