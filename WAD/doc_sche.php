...
<!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
<br><h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal; text-align:center; color:#51b8f1;"> Doctor Schedule</h1><br>
...
<div class="dropdown2" style="top: 250px;
	left:290px;">
<a href="doc_add_sch.php" target="iframe_a"><button  class="dropbtn2" data-src="doc_add_sch.php" onClick="doc_add_sch.php" id="b1" >Add</button></a>
...
<div class="dropdown2" style="top: 250px;
	left:450px;">
<a href="doc_up_sch.php" target="iframe_a"><button onclick="postYourAdd()" class="dropbtn2" id="b1" >Update</button></a>
...
<div class="dropdown2" style="top: 250px;
	left:610px;">
<a href="doc_sea_sch.php" target="iframe_a"><button onclick=" " class="dropbtn2" formtarget="doc_sea_sch.php" >Search</button></a>
  <div id="myDropdown2" class="dropdown-content2">
