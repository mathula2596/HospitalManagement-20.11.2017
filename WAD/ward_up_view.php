...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="ward_up_se.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:90px;"><?php echo $di[5]; ?></td>
                 <td class="bod" style="text-align: center; width:30px; " ><a href="update_ward_form.php? A_id=<?php echo $di[0];?>">Edit</a> </td>
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:90px;"><?php echo $an[5]; ?></td>
                 <td class="bod" style="text-align: center; width:30px; " ><a href="update_ward_form.php? A_id=<?php echo $an[0];?>">Edit</a> </td>
     ...
     ?>
      ...
      <td class="bod" style="text-align: center; width:30px; " ><a href="update_ward_form.php? A_id=<?php echo $dda[0];?>">Edit</a> </td>
			</tr>
	...
	?>
			<tr>
                ...
                <td class="bod" style="text-align: center;  width:90px;"><?php echo $ad[5]; ?></td>
                 <td class="bod" style="text-align: center; width:30px; " ><a href="update_ward_form.php? A_id=<?php echo $ad[0];?>">Edit</a> </td>
