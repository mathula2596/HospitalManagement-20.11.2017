...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="doc_del_se.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<tbody><tr><td></td></tr>
   ...
   <th width="100" style="border-radius: 5px; width:50px; background-color:#51b8f1; color: #ffffff; text-align: center;">Delete</th>
    ...
    <?php
		...
		if($cbo=="ID"&&$text1=="")
		{
			$id = mysql_query("SELECT * FROM receiptionist WHERE ID='$search'");
	?>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $di[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_rec.php? id=<?php echo $di[0];?>" >Delete</a> </td>
		...
		{
			$na = mysql_query("SELECT * FROM receiptionist WHERE F_Name like '".$search."'");
	?>
    <?php
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $an[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_rec.php? id=<?php echo $an[0];?>" >Delete</a> </td>
     ...
     <?php
				...
				{
        $pn = mysql_query("SELECT * FROM receiptionist WHERE Phone like '".$search."'");
     ?>
		<?php
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $np[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_rec.php? id=<?php echo $np[0];?>" >Delete</a> </td>
		...
		{
			$da = mysql_query("SELECT * FROM receiptionist WHERE DOJ like '".$date."'");
	?>
    <?php
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $ad[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_rec.php? id=<?php echo $ad[0];?>" >Delete</a> </td>
		...
		{
			$da = mysql_query("SELECT * FROM receiptionist WHERE DOJ like '".$date."' and ID='$search' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
		...
		{
			$da = mysql_query("SELECT * FROM receiptionist WHERE DOJ like '".$date."' and F_Name like '".$search."' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
		...
		{
			$da = mysql_query("SELECT * FROM receiptionist WHERE DOJ like '".$date."' and Phone like '".$search."' ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
