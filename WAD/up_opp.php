...
<?php   
        ...
        include "connect.php";
        $i = mysql_query("UPDATE  theater SET  p_id='".$_POST['id']."',d_id='".$_POST['did']."',parts='".$_POST['parts']."',Reason='".$_POST['reason']."',	date='".$_POST['date']."',time='".$_POST['time']."' WHERE o_no='".$_POST[o_no]."'");
        if($i==true){
