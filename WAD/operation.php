...
<option selected hidden="">Choose the Parts</option>
<option>Head</option>
...
<?php   
        ...
        include "connect.php";
        $i = mysql_query("insert into theater values('".$_POST['no']."','".trim($_POST['id'])."','".trim($_POST['did'])."','".trim($_POST['parts'])."','".trim($_POST['reason'])."','".trim($_POST['date'])."','".$_POST['time']."')");
        if($i==true){
