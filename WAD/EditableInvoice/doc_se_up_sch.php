...
<br>
 ...
 <table align="center">
     ...
     <?php   
        ...
        include "connect.php";
        $i = mysql_query("UPDATE doctor_sch SET M_I='".$_POST["M_In"]."', 	M_O='".$_POST[M_Ou]."',Tu_I='".$_POST[Tu_In]."',Tu_O='".$_POST[Tu_Ou]."',W_I='".$_POST[W_In]."',W_O='".$_POST[W_Ou]."', Th_I='".$_POST[Th_In]."',Th_O='".$_POST[Th_Ou]."',F_I='".$_POST[F_In]."',F_O='".$_POST[F_Ou]."',Sa_I='".$_POST[Sa_In]."',Sa_O='".$_POST[Sa_Ou]."'Su_I='".$_POST[Su_In]."',Su_O='".$_POST[Su_Ou]."' WHERE ID='".$_POST[id]."'");
        if($i==true){
