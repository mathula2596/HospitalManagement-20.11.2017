...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal;  position: absolute; left: 380px; top: 150px; color:#51b8f1;"> Operation Records</h1>
...
<tbody>
        ...
        <tr >
           ...
           <td class="bod" style="text-align: center;  width:80px;"><?php echo $tr[7]; ?></td>


              
               
               
           <td class="bod" style="text-align: center; width:30px; " ><a href="up_opp.php? o_no=<?php echo $tr[0];?>">Edit</a> </td>
           <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $tr[0];?>">Delete</a> </td>
           <?php
