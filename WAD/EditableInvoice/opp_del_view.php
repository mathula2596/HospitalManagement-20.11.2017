...
<tbody><tr><td></td></tr>
	...
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $di[6]; ?></td>
                         ...
                         <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $di[0];?>">Delete</a> </td>
...
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $an[0];?>">Delete</a> </td>			</tr></tr>
            <?php
		}
	...
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $an[6]; ?></td>
                        <td class="bod" style="text-align: center;  width:80px;"><?php echo $an[7]; ?></td>
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $an[0];?>">Delete</a> </td>			</tr>
            <?php
				}
			?>  
     <?php
...
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $dda[0];?>">Delete</a> </td>			</tr>
				<?php
				}
			?>  
     <?php
...
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $dda[0];?>">Delete</a> </td>			</tr>
	...
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $ad[6]; ?></td>
                        <td class="bod" style="text-align: center;  width:80px;"><?php echo $ad[7]; ?></td>
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $ad[0];?>">Delete</a> </td>			</tr>
				
		<?php 
		}}
			elseif($cbo1=="Date"&&$cbo=="P_ID")
		{
			$da = mysql_query("SELECT * FROM theater WHERE date like '".$search1."' and p_id like '".$search."'  ");
	?>
    <?php
		while($ad=mysql_fetch_array($da))
		{
	?>
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $ad[6]; ?></td>
                        <td class="bod" style="text-align: center;  width:80px;"><?php echo $ad[7]; ?></td>
<td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="del_opp.php? o_no=<?php echo $ad[0];?>">Delete</a> </td>			</tr><?php 
		}}
