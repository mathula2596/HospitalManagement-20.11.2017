...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal;  position: absolute; left: 380px; top: 150px; color:#51b8f1;">Doctor Details</h1>
...
<tbody>
    ...
    <tr></tr><br>
        <tr >
            ...
            <td class="bod" style="text-align: center;  width:80px;"><?php echo $tr[12]; ?></td>




            <td class="bod" style="text-align: center; width:30px; " ><a href="do_up_fo.php? D_id=<?php echo $tr[0];?>">Edit</a> </td>
            <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="deletedoc.php? D_id=<?php echo $tr[0];?>" >Delete</a> </td>
           <?php
