...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal;  position: absolute; left: 380px; top: 150px; color:#51b8f1;">Receiptionist Details</h1>
...
<tbody>
    ...
    <tr></tr><br>
        <tr >
           ...
           <td class="bod" style="text-align: center; width:30px; " ><a href="rec_up_fo.php? id=<?php echo $tr[0];?>">Edit</a> </td>
           <td class="bod" style="text-align: center; width:30px; " ><a href="deleteapp.php? A_ID=<?php echo $tr[0];?>">Delete</a> </td>
           <?php
