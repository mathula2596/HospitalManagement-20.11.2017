...
<div class="summary"> <table > <tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
  ...
  <td></td><td></td><td></td><td></td><td align="right"><?php echo $login_session; ?> <td></td><td></td><td align="right"> <font style="font-size:18px;"><a href="doc_up_se.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
   ...
   <th width="100" style="border-radius: 5px; width:50px; background-color:#51b8f1; color: #ffffff; text-align: center;">Edit</th>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $di[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="rec_up_fo.php? id=<?php echo $di[0];?>">Edit</a> </td>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $an[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="rec_up_fo.php? id=<?php echo $an[0];?>">Edit</a> </td>
     ...
     ?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $np[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="rec_up_fo.php? id=<?php echo $np[0];?>">Edit</a> </td>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $ad[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="rec_up_fo.php? id=<?php echo $ad[0];?>">Edit</a> </td>
