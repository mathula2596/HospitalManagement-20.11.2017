   ...
   <th width="100" style="border-radius: 5px; width:50px; background-color:#51b8f1; color: #ffffff; text-align: center;">Edit</th>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $di[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="admin_up_fo.php? id=<?php echo $di[0];?>">Edit</a> </td>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $an[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="admin_up_fo.php? id=<?php echo $an[0];?>">Edit</a> </td>
     ...
     ?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $np[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="admin_up_fo.php? id=<?php echo $np[0];?>">Edit</a> </td>
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $ad[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a href="admin_up_fo.php? id=<?php echo $ad[0];?>">Edit</a> </td>
