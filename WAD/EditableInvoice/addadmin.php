...
<td><input type="NUMBER" name="p_number1" size="30" placeholder="Enter the contact number" /></td></tr>
<tr>
...
<td><input type="password" name="password" size="30" placeholder="Enter the Password"  /></td></tr>

<tr></tr><tr></tr><tr></tr>

<tr><td>
<label> Confirm Password : </label></td>
<td><input type="password" name="c_password" size="30" placeholder="Retype the Password"  /></td></tr>
