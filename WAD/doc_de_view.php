			...
			if($di[10]!="")
{
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $di[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="deletedoc.php? D_id=<?php echo $di[0];?>" >Delete</a> </td>
			...
			if($an[10]!="")
{
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $an[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="deletedoc.php? D_id=<?php echo $an[0];?>" >Delete</a> </td>
			...
			if($np[10]!="")
{
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $np[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="deletedoc.php? D_id=<?php echo $np[0];?>" >Delete</a> </td>
			...
			if($ad[10]!="")
{
	...
	?>
        ...
        <td  class="bod" style="text-align: center; width:55px;"><?php echo $ad[0]; ?></td>
          ...
          <td class="bod" style="text-align: center; width:30px; " ><a onclick="javascript:return confirm('Are you sure do you want to delete this?')" href="deletedoc.php? D_id=<?php echo $ad[0];?>" >Delete</a> </td>
