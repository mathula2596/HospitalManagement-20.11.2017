...
<br><br><br><br><br>
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal;  position: absolute; left: 350px; color:#51b8f1;"> Search Here for Update</h1>
<br><br><br><br><br><br><br>

<div style="height: 200px; width: 600px; border: solid #51b8f1; margin: auto; ">
	
	<table align="center">
		<form action="2.php" name="search" method="post">
		<tr>
			<td align="right"> 
...
<option>Date</option>
		...
		<td><input type="date" name="date1" size="30"  value=""  / > </td>
