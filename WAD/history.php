...
<tr>
	<td colspan="2"><h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal; text-align:center; color:#51b8f1;"> Patient History</h1><br><br></td>
...
<td><input type="text" name="name" size="30"  value="" readonly / ></td>
</tr>
...
<td><textarea rows="10" cols="30" name="reason" required > </textarea></td></tr>
...
<td><input type="text" name="d_id" size="30"  value="" readonly / ></td>
</tr>
...
<td><td><input type="text" name="d_name" size="30"  value="" readonly / ></td></td>
</tr>
...
<td><input type="date" name="date" size="30"  required class="manual" /></td></tr>
...
<td><input type="time" name="time" size="30"  /></td></tr>
...
<td><input type="reset" name="reset" value="Reset" /></td></tr>
 ...
 <?php   
        ...
        include "connect.php";
        $i = mysql_query("insert into patient values('".$_POST['id']."','".trim($_POST['f_name'])."','".trim($_POST['l_name'])."','".trim($_POST['p_number1'])."','".trim($_POST['p_number2'])."','".trim($_POST['date'])."','".trim($_POST['age'])."','".trim($_POST['address'])."','".trim($_POST['gender'])."','".trim($_POST['admission'])."','".trim($_POST['reason'])."')");
        if($i==true){
