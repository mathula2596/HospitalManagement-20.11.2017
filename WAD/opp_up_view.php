...
<div class="summary"> <label style="text-align: right">     User Login     : </label>  <?php echo $login_session; ?> <p align="right" style="position: absolute; top: -12px;left: 1000px;"> <font style="font-size:18px;"><a href="opp_up.php">Back </a> </font>
 </td></tr></table>
</div>
<!--logo file end-->
...
<!--                         <td class="bod" style="text-align: center;  width:80px;"><?php// echo $di[7]; ?></td>-->
                         ...
                         <td class="bod" style="text-align: center; width:30px; " ><a href="up_opp.php? o_no=<?php echo $di[0];?>">Edit</a> </td>
...
<!--                        <td class="bod" style="text-align: center;  width:80px;"><?php //echo $an[7]; ?></td>-->
 <td class="bod" style="text-align: center; width:30px; " ><a href="up_opp.php? o_no=<?php echo $an[0];?>">Edit</a> </td>
			</tr></tr>
            <?php
		}
...
<!--                        <td class="bod" style="text-align: center;  width:80px;"><?php //echo $dda[7]; ?></td>-->
 <td class="bod" style="text-align: center; width:30px; " ><a href="up_opp.php? o_no=<?php echo $dda[0];?>">Edit</a> </td>
			</tr>
				<?php
				}
			?>  
...
<!--                        <td class="bod" style="text-align: center;  width:80px;"><?php //echo $an[7]; ?></td>-->
 <td class="bod" style="text-align: center; width:30px; " ><a href="up_opp.php? o_no=<?php echo $ad[0];?>">Edit</a> </td>
			</tr>
