...
<h1 style="font-family:Georgia, 'Times New Roman', Times, serif; font-style:normal;  position: absolute; left: 380px; top: 150px; color:#51b8f1;"> Ward Records</h1>
<br><br><br><br><br>
...
<tbody>
        ...
        <tr >
            ...
            <td class="bod" style="text-align: center; "><?php echo $tr[4]; ?></td>
                        <td class="bod" style="text-align: center; "><?php echo $tr[5]; ?></td>
                         <td class="bod" style="text-align: center; width:30px; " ><a href="update_ward_form.php? A_id=<?php echo $tr[0];?>">Edit</a> </td>
           <td class="bod" style="text-align: center; width:30px; " ><a onClick="javascript:return confirm('Are you sure do you want to delete this?')" href="delete_ward.php? A_id=<?php echo $tr[0];?>">Delete</a> </td>
